...
from Models.vision_aided_loss.DiffAugment_pytorch import DiffAugment
from Models.vision_aided_loss.CLIP.clip import *
...
class DINOv2Reg(torch.nn.Module):
    ...
    def __init__(self, cv_type='adv'):
        ...
        # self.model = torch.hub.load('/your_local_dir/facebookresearch_dinov2_main', 'dinov2_vitb14_reg', source='local')
        self.model.eval()
        self.model.requires_grad = False
        self.input_resolution = 224
        self.image_mean = torch.tensor([0.485, 0.456, 0.406])
